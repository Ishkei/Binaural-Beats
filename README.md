# Binaural-Beats Essentially it is a dynamic binaural beat. In the beginning of the track in the left and right channel the tone is equal in pitch. As the track progresses the pitch increases in one channel and decreases in the other until we reach the middle of the track, the middle point is thus the max deferential, it then reverses until at the end it is the same tone.
